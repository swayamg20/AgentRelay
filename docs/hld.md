...
only the internal read-only Codex composition binds it to the guardian. The
...
owner-prepared checkout -> read-only containment -> pinned Codex sandbox/app-server
```
